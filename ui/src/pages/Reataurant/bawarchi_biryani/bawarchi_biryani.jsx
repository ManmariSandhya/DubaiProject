...
export function BawarchiBiryaniComponent() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:6010/api/bookItem', bookItem);
            alert("Details saved")
                ...
                <div>
                    <Tabs defaultActivekey="1" >
                        ...
                        <TabPane tab="Review & Ratings" key="3" style={{width:'400px'}}>
                            ...
                            <div className='mt-3'>
                                <span style={{ border: '1px solid', color: 'white', background: 'green', padding: '5px', borderRadius: '3px' }}>4.2<StarFill style={{ fontSize: '10px' }}></StarFill></span>
                                &nbsp;&nbsp;
                                <span>Biryani</span>
    ...
    <hr></hr>
                        ...
                        <TabPane tab="Book Your Order" key="4" style={{width:'400px'}}>
                            ...
                            <form onSubmit={handleSubmit} >
                                <div class="row g-3">
                                    ...
                                    <div class="col">
                                        <input type="text" name='lastname' value={bookItem.lastname} className="form-control" placeholder="Last name" aria-label="Last name" onChange={handleChange} style={{width:'400px'}} />
                                    </div>
                                </div>
                                <div class="row g-3 mt-2">
                                    ...
                                    <div class="col">
                                        <input type="text" name="phonenumber" value={bookItem.phonenumber} className="form-control" placeholder="Phone Number" aria-label="Phone Number" onChange={handleChange} style={{width:'400px'}}/>
                                    </div>
                                </div>
                                <div>
