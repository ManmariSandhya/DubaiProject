...
export function HaleemComponent() {
    return (
        <div>
                ...
                <div className='row'>
                        ...
                        <div className="card haleem_card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Paradise, Begumpet &nbsp; &nbsp;
                                    <span className='haleem_ratings'>4.5<StarFill style={{ fontSize: '15px' }}></StarFill></span>
                                </h5>
                        ...
                        <div className="card haleem_card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Bawarchi, Abids &nbsp; &nbsp; &nbsp; &nbsp;
                                    <span className='haleem_ratings'>4.8<StarFill style={{ fontSize: '15px' }}></StarFill></span>
                                </h5>
                    ...
                    <div className='col-3'>
                        <div className="card haleem_card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Grand Hotel, Abids &nbsp; &nbsp;
                                    <span className='haleem_ratings'>4.1<StarFill style={{ fontSize: '15px' }}></StarFill></span>
                                </h5>

                                <h6 className="card-subtitle mb-2 text-muted">Mutton Haleem</h6>
                                <h6>Mrp : <CurrencyRupee></CurrencyRupee>300rs</h6>
                                <p className="card-text">
                                    Location: SD Road, Sappu Bagh Apartment, Jogani, Ramgopalpet, Secunderabad, Telangana 500003</p>
                                <a href="#" className="card-link" style={{ textDecoration: 'none' }}>Order Now</a>
                                <a href="#" className="card-link" style={{ textDecoration: 'none' }}>Contact Us</a>
                ...
                <div className='row'>
                        ...
                        <div className="card haleem_card" style={{ width: "18rem" }}>
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Pistha House &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    <span className='haleem_ratings'>4.7<StarFill style={{ fontSize: '15px' }}></StarFill></span>
                                </h5>
                    ...
                    <div className='col-3'>
                        <div className="card haleem_card" style={{ width: "18rem" }}>
                            <img src={haleem1} className="card-img-top" alt="..."></img>
                            <div className="card-body">
                                <h5 className="card-title">AI Madena &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;
                                    <span className='haleem_ratings'>4.2<StarFill style={{ fontSize: '15px' }}></StarFill></span>
                                </h5>

                                <h6 className="card-subtitle mb-2 text-muted">Mutton Haleem</h6>
                                <h6>Mrp : <CurrencyRupee></CurrencyRupee>390rs</h6>
                                <p className="card-text">
                                    Location: SD Road, Sappu Bagh Apartment, Jogani, Ramgopalpet, Secunderabad, Telangana 500003</p>
                                <a href="#" className="card-link" style={{ textDecoration: 'none' }}>Order Now</a>
                                <a href="#" className="card-link" style={{ textDecoration: 'none' }}>Contact Us</a>
